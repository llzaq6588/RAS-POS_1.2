...
<p>&nbsp;</p>
<table border="1" width="1333" align="center">
    <tr>
        <td width="298">
...
$sql="select * from price where name like '%$name%'"; //본래 like문을 사용할 생각이었으나 본 서버에서 한글 인코딩이 こなごな 박살남으로 부분 한글검색은 불가능하였다. <ex 검색할 내용이 '자갈치'라면 '자갈'만 입력하더라도 나올 수 있도록 해주는 검색기능> 혹시 mysql 한글 인코딩이 안 깨어지는 서버라면 like문이 잘 될 것이다.
...
?></span></font></p>
        ...
        <td width="422" height="27">                                                <p style="line-height:200%;" align="center">
<font face="HY울릉도B"><span style="font-size:24pt;"><?php
$name = $_POST['name']; //name변수는 select문으로 찾게되어 해당 정보가 출력된다. 출력내용은 code, name, price이다.
